...
I am a Ph.D. student at Rensselaer Polytechnic Institute ([RPI](https://www.rpi.edu)). My research applies the fundamentals of [Energy-based modeling](https://bhqpham.com/research/2025/12/15/ebm.html) and [Dense Associative Memory](https://arxiv.org/abs/1606.01164) (also known as modern [Hopfield networks](https://en.wikipedia.org/wiki/Hopfield_network)) for the designing of new neural architectures and understanding the interplay between memorization and generalization in deep generative models, such as diffusion models.
