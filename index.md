...
I am a Ph.D. student at Rensselaer Polytechnic Institute ([RPI](https://www.rpi.edu)). My research applies the fundamentals of energy-based modeling and [Dense Associative Memory]((https://arxiv.org/abs/1606.01164)) (also known as modern [Hopfield networks](https://en.wikipedia.org/wiki/Hopfield_network)) for the designing of new neural architectures and understanding the interplays between memorization and generalization in deep generative models, such as diffusion models.
